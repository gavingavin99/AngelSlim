...
# ==========================================================================
# AngelSlim DFlash Offline Training — Fully Aligned Configuration
# ==========================================================================
#
# Trains a DFlash draft model from pre-computed hidden-state .ckpt files.
# Prerequisite: run scripts/speculative/generate_dflash_data.sh first to
# produce the .ckpt files at $TRAIN_HIDDEN_PATH.
#
...
#
# Usage:
#   bash scripts/speculative/run_dflash_offline.sh [NUM_GPUS] [ATTENTION_BACKEND]
#
# ==========================================================================
...
WANDB_RUN_NAME=${WANDB_RUN_NAME:-"angelslim-qwen3-4b-dflash-offline-fp32master"}
